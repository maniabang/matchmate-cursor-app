...
export default function ProfileView({ profile, isMyProfile }: { profile: Profile; isMyProfile: boolean }) {
  ...
  return (
    ...
    >
      <button onClick={() => router.back()} style={profileBackButtonStyle} aria-label="뒤로가기">
        ←
      </button>
